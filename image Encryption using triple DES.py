...
salt_const=b"$ez*8}-d3](%d%$#*!)$#%s45le$*fhu2cdivyanqufguqgrubakpqmnashu75456dg1fdmbxrfgfs^9"
...
def encryptor(path):
	...
	try:
		...
		print("Encryption failed...Possible causes:Library not installed properly/Incorrect padding or conversions")
		exit()
...
#Documentations
print("-----------------------------------------------------------------------------------------------------------------------------------")
print("✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️  IMAGE ENCRYPTION DECRYPTION USING  triple-DES  ✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️✈️")
print("")
print("")
